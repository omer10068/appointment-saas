...
describe('Business.status dashboard access enforcement (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    await prisma.business.deleteMany({
      where: { id: { in: [SUSPENDED_BIZ_ID, CANCELLED_BIZ_ID] } },
    });
